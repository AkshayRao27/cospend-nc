...
- Synced with upstream 4.1.2 (Nextcloud 36 support, access-level check refactor, REUSE migration,
  eslint flat config, Vue 3 component renames)
...
- Fix accessing potentially undefined array keys
